                ...
                <div className="proj-cards">
                    <div className="sm:flex gap-5">
                        <div className="grow border mb-5 sm:mb-0 flex flex-col items-center px-5 py-7 rounded-3xl border-slate-500 justify-around">
                           <img src={ecom} alt="ecom" className="rounded-xl border" />
                        ...
                        <div className="grow border mb-5 sm:mb-0 flex flex-col items-center p-5 rounded-3xl border-slate-500 justify-around">
                           <img src={dlog} alt="ecom" className="rounded-xl border" />
                           <p className="text-xl mb-5 font-bold">Daily Log</p>
                           <div className="social-links ">
                        ...
                        {/* ------------------------------------------- */}
                        <div className="grow border mb-5 sm:mb-0 flex flex-col items-center p-5 rounded-3xl border-slate-500 justify-around">
                           <img src={cuisine} alt="ecom" className="rounded-xl border" />
                           <p className="text-xl mb-5 font-bold">Cuisine</p>
                           <div className="social-links ">
